...
| **バックテスト層** | ✅ 本リポに移管済 | 8 戦略移管完了。tail-test / walk-forward / portfolio 分析フレームワーク実装済。SPY Credit Spread は tail-test **6/7 PASS**（Max DD 21.6%、CVaR -$216）|
...
- [docs/spy-credit-spread-roadmap.md](docs/spy-credit-spread-roadmap.md)（CAGR 未達への対応ロードマップ）
...
| **14** | **90 日 paper trading 観察 (Phase F)** | 🚧 **観察中** | KOH-457 |
| 15 | 最終評価 + 本番判断 (Phase G) | 📋 | KOH-458 |
| 16 | 本番取引開始（Alpaca live、段階サイズアップ）| 📋 | KOH-459 |
